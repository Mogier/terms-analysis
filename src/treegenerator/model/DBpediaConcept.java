...
public class DBpediaConcept extends OnlineConcept {
	...
	public DBpediaConcept(JSONObject dbpediaJSON, int idConcept, Integer base) throws JSONException {
	...
	public DBpediaConcept(String URI, String labelResource,int idConcept, Integer base) throws JSONException {
